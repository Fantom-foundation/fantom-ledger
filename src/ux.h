#ifndef FANTOM_LEDGER_UX_H
#define FANTOM_LEDGER_UX_H
...
#define UI_TEXT(userid, x, y, w, text) \
    {{BAGL_LABELINE,userid,x,y,w,12,0,0,0,0xFFFFFF,0,BAGL_FONT_OPEN_SANS_REGULAR_11px|BAGL_FONT_ALIGNMENT_CENTER,0},\
    (char *)text,0,0,0,NULL,NULL,NULL}

// ui_idle displays the main menu screen. Command handlers should call ui_idle when they finish.
void ui_idle(void);

#endif //FANTOM_LEDGER_UX_H
